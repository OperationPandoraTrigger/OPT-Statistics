<?php
    ...
    $sql_missions = "SELECT ID, Start, End, Fractions, MissionFileName, CampaignName, MissionName FROM Missions WHERE ID = $SelectedMissionID LIMIT 1;";
    ...
    echo json_encode(array("FPS"=>$FPS));
    mysqli_close($dbh);
?>
